...
# -*- coding: utf8 -*-
"""
Module defining SmartMem10Trader agent class.
"""
...
class SmartMem10Trader(agents.Agent):
    """
    ...
    The SmartMem10Trader acts by returning a
