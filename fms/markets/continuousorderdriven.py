...
class ContinuousOrderDriven(markets.Market):
    ...
    >>> from fms.utils import BUY, SELL
    >>> market.record_order(agentbob,{'direction':BUY, 'price':2.50, 'quantity':10}, 0, False)
    >>> market.buybook
    [[2.5, 0, 10, <fms.agents.Agent instance at ...>]]
    >>> market.sellbook
    []
    >>> market.record_order(agentsmith,{'direction':SELL, 'price':3.50, 'quantity':20}, 1, False)
    >>> market.buybook
    [[2.5, 0, 10, <fms.agents.Agent instance at ...>]]
    >>> market.sellbook
    ...
    >>> market.record_order(agentsmith,{'direction':SELL, 'price':3.50, 'quantity':40}, 2, False)
    ...
    is 3.5
    >>> market.record_order(agentbob,{'direction':BUY, 'price':3.00, 'quantity':60}, 3, False)
    ...
    >>> market.record_order(agentbob,{'direction':BUY, 'price':3.60, 'quantity':15}, 4, False)
    ...
    >>> market.record_order(agentbob,{'direction':BUY, 'price':3.60, 'quantity':17}, 5, False)
    ...
    in the buybook.
    >>> market.record_order(agentbob,{'direction':BUY, 'price':3.55, 'quantity':50}, 6, False)
    ...
    buy limit (3.55) :
    >>> market.record_order(agentsmith,{'direction':SELL, 'price':3.40, 'quantity':6}, 7, False)
    ...
    >>> market.record_order(agentsmith,{'direction':SELL, 'price':2.80, 'quantity':45}, 8, False)
    ...
    >>> market.record_order(agentsmith,{'direction':SELL, 'price':2.60, 'quantity':42}, 9, False)
    ...
    >>> market.record_order(agentbob,{'direction':SELL, 'price':3., 'quantity':20}, 10, False)
    ...
    one
    >>> market.record_order(agentbob,{'direction':SELL, 'price':2.8, 'quantity':30}, 11, False)
    ...
    >>> market.record_order(agentsmith,{'direction':BUY, 'price':2.4, 'quantity':25}, 12, False)
    ...
    >>> market.record_order(agentsmith,{'direction':BUY, 'price':2.45, 'quantity':15}, 13, False)
